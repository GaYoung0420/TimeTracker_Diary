...
import { generateDailyReflection } from './services/aiService.js';
import { buildDailyReflectionPrompt } from './utils/promptBuilder.js';
...
export function setupAIAPI(app, supabase) {
  ...
  try {
    ...
    // 8. Claude API 호출
    const aiReflection = await generateDailyReflection(prompt);
